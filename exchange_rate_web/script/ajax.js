		...
		$.ajax({				
			...
			success : function(response){
				if(response.error == 1){	
					...
					$("#converted_rate").html("<strong>Exchange Rate ("+response.to_Currency+") : "+response.rate+"</strong>");
					$("#converted_rate").show();
					$("#converted_amount").html("<strong>Converted Amount ("+response.to_Currency+") : "+response.converted_amount+"</strong>");
